...
class Rectangle {
  ...
  css() {
    return mem(() => css(rect(this.x() + this.unit("x"), this.y() + this.unit("y"), mobile() ? "90vw" : this.w() + this.unit("w"), this.h() + this.unit("h"), this.opts())) + (this.opts().material?.css?.() ?? ""));
  }
}
...
const Banner = (() => {
  ...
  let html = () => {
    let ref;
    mounted(() => drag(ref, {set_left: (px2) => rectangle.x(px_to_vw(px2)), set_top: (px2) => rectangle.y(px_to_vh(px2))}));
    return hdom([
      ".banner",
...
let Schedule = function() {
  let css2 = [
    ...
    [
      ...
      {
        margin: [[0, rem(1.25)]],
        padding: [[rem(0.85), rem(0.55), rem(1.5), rem(0.55)]],
...
let Timing = function() {
  ...
  const html = () => {
    let ref2;
    mounted(() => drag(ref2, {set_left: (px2) => rectangle.x(px_to_vw(px2)), set_top: (px2) => rectangle.y(px_to_vh(px2))}));
    return hdom([
      ".timing",
...
const maskcontainer = (first, second, rectangle, t = 500) => {
  ...
  const html = () => {
    return hdom([".masked", {style: inlinecss}, () => each(ordered, render2)]);
  };
  onanimationend();
...
let Alternative = Dual("Alternative", new Rectangle(0, 0, 25, 10, {strategy: "absolute"}), void 0, 750);
let Practices = Dual("Practices", new Rectangle(0, 10, 25, 10, {strategy: "absolute"}), void 0, 500);
