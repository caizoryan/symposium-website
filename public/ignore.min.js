...
class Rectangle {
  ...
  css() {
    return mem(() => {
      ...
      return css(rect(this.x() + this.unit("x"), this.y() + this.unit("y"), mobile() ? "90vw" : this.w() + this.unit("w"), this.h() + this.unit("h"), this.opts())) + (this.opts().material?.css?.() ?? "") + (hunit == "auto" ? "height: auto;" : "");
    });
  }
}
