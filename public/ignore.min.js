...
space.add(masked);
animate.prop([
  {start: 0, end: 20, duration: 1e3},
  {start: 50, end: 70, duration: 500},
  {start: 0, end: 20, duration: 1e3},
  {start: 50, end: 70, duration: 500},
  {start: 20, end: 90, duration: 1e3}
], masked.rectangle.y).setEasing("OutCubic");
animate.prop([
  {start: 5, end: 20, duration: 1e3},
  {start: 50, end: 70, duration: 1500},
  {start: 5, end: 20, duration: 1e3},
  {start: 70, end: 90, duration: 1500},
  {start: 20, end: 30, duration: 1e3}
], masked.rectangle.x).loop();
